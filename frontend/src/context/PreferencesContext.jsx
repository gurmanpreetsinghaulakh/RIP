...
const DICTIONARY = {
    English: {
        ...
        'profile.marketing': 'Marketing Communication'
    },
    Hindi: {
        'nav.explore': 'खोजें',
        'nav.saved': 'सहेजा गया',
        ...
        'profile.marketing': 'मार्केटिंग संचार'
    },
    Spanish: {
        ...
        'profile.marketing': 'Comunicación de marketing'
    },
    French: {
        ...
        'profile.marketing': 'Communication marketing'
    }
};
...
export function PreferencesProvider({ children }) {
    ...
    useEffect(() => {
        const fetchRates = async () => {
            try {
                ...
                console.warn("Failed to fetch from primary rate API, trying fallback API:", error);
                try {
                    ...
                    console.error("All exchange rate APIs failed, using local fallbacks:", fallbackError);
                }
            }
        };
        fetchRates();
    ...
    return (
        <PreferencesContext.Provider value={{ currency, language, formatPrice, t, updatePreferences, adminSettings, updateAdminSettings }}>
            {children}
