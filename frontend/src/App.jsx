...
function AppRoutes() {
  ...
  const isBare =
    ["/", "/login", "/signup", "/signup/verify", "/confirmation"].includes(
      location.pathname,
    ) ||
    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={adminGuard(<AdminAnalytics />)}
        />
        ...
        <Route
          path="/confirmation"
          element={userGuard(<BookingConfirmation />)}
        />
        ...
        >
          ...
          >
            ...
            >
              ...
              platform. We will be back online shortly!
            </p>
            <div
              style={{
                fontSize: "0.825rem",
            ...
            >
              Thank you for your patience. Only administrators can access and
              update the platform at this time.
            </div>
            <button
